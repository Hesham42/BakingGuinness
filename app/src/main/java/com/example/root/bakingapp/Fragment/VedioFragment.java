...
public class VedioFragment extends android.app.Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.vedio_details_fragment, container, false);
        ...
        if(savedInstanceState == null)
        {
            ...
            currentIndex = bundle.getInt(getResources().getString(R.string.current));
            tablet = bundle.getBoolean(getResources().getString(R.string.tablet));
        }
        else
        {
            steps = savedInstanceState.getParcelableArrayList(getResources().getString(R.string.steps));
            currentIndex = savedInstanceState.getInt(getResources().getString(R.string.index));
            tablet = savedInstanceState.getBoolean(getResources().getString(R.string.tablet));
        }
        show();
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(getResources().getString(R.string.index),currentIndex);
